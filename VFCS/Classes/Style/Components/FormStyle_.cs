...
namespace VFCS
{
    class FormStyle_ : Component
    {
        ...
        public Font HeaderTextFont { get; set; } = new Font("Modern No. 20", 11.999999F, FontStyle.Regular);
        ...
        public FormStyle_(IContainer container)
        {
            DefineStyles();
        ...
        private void DefineStyles()
        {
            ...
            StylesDictionary.Add(fStyle.SimpleDark,
                new Style()
                {
                    ...
                    HeaderTextFont = new Font("Modern No. 20", 11.999999F, FontStyle.Regular),
            ...
            StylesDictionary.Add(fStyle.TelegramStyle,
                new Style()
                {
                    ...
                    HeaderTextFont = new Font("Modern No. 20", 11.999999F, FontStyle.Bold),
