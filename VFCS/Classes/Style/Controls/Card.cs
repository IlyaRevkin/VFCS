...
namespace VFCS
{
    public class Card : Control
    {
        ...
        public Font FontHeader { get; set; } = new Font("Arial", 12F, FontStyle.Bold);
        ...
        public Font FontDescrition { get; set; } = new Font("Arial", 8.25F, FontStyle.Regular);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            //Обводка
            graph.DrawRectangle(new Pen(FlatColors.LightGray), rect);
            ...
            graph.DrawString(Text, Font, new SolidBrush(ForeColor), 20, Height -37);
